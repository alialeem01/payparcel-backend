...
MANAGER_APPS = ['customers', 'parcels', 'operations', 'riders', 'invoices', 'locations']
RIDER_APPS = ['riders']
...
class CustomGroupAdmin(ModelAdmin):
    ...
    def _grouped_permissions(self, selected_ids=None):
    ...
    def custom_add_view(self, request):
        ...
        context = {
            **self.admin_site.each_context(request),
            ...
            'manager_apps': json.dumps(MANAGER_APPS),
            'rider_apps': json.dumps(RIDER_APPS),
    ...
    def custom_change_view(self, request, object_id):
        ...
        context = {
            **self.admin_site.each_context(request),
            ...
            'grouped_permissions': self._grouped_permissions(selected_ids),
            'manager_apps': json.dumps(MANAGER_APPS),
            'rider_apps': json.dumps(RIDER_APPS),
            'opts': self.model._meta,
        }
